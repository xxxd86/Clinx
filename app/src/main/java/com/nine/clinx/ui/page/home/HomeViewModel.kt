...
import com.nine.clinx.dynamic.ViewState
import com.nine.clinx.ui.page.home.*
...
@HiltViewModel
class HomeViewModel@Inject internal constructor() : DynamicViewModel() {
...
////    val projects = Pager(
////        PagingConfig(pageSize = 2, initialLoadSize = 6, // 第一次加载数量，如果不设置的话是 pageSize * 2
////        prefetchDistance = 2)
////    ){
////        SimpleSource()
